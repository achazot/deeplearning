...
Une architecture de CNN répandue est composée des couches suivantes, dont les dimensions sont données à titre d'exemple pour un système utilisant les entrées de la base CIFAR 10 RGB :
...
\begin{figure}[H]
    ...
    \caption{Représentation simplifiée d'un CNN}
    \label{fig:c1p3s1}
\end{figure}
